...
@Data
public class ErpFeedOutSaveReqVO {
    ...
    @DecimalMin(value = "0.00", inclusive = false, message = "重量必须大于0")
    @Digits(integer = 8, fraction = 2, message = "重量整数部分不能超过8位，小数部分不能超过2位")
